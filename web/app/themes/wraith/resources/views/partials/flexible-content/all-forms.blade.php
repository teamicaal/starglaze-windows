          ...
          @if (have_rows('all_forms'))
            @while (have_rows('all_forms'))
              ...
              @endphp
                  ...
                  <a href="{{ $form_link }}" class="lg:w-[30%] w-full rounded-lg max-h-[170px] mb-6 lg:mr-6 text-center flex flex-col justify-center items-center bg-white hover:bg-primary group hover:border-none border-none">
