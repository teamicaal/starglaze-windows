...
<section id="showroom-info-block" class="relative flex justify-center items-center">
    <div class="grow flex justify-center items-center relative m-4 rounded-lg overflow-hidden h-[80vh] py-24 px-16">
        ...
        <div class="relative p-8 flex flex-col justify-center items-center max-w-[1000px] rounded-lg border border-white h-auto">
            <h2 class="font-serif font-bold text-3xl md:text-4xl mb-6 text-white tracking-wide ">{{ $title }}</h2>
            <div class="child-p:text-white p-4 text-center px-20 pt-0 pb-8 text-lg">{!! $paragraph !!}</div>
