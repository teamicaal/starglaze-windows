			...
			<div class="flex flex-col relative {{ $i % 2 == 0 ? 'lg:flex-row-reverse flex-col mb-8' : 'lg:flex-row flex-col mb-8' }}">
				...
				<div class="w-full lg:w-3/5">
					<div class="embed embed-16by9 ">
						<iframe src="{!! $video_iframe_url !!}" class="object-cover-absolute w-full h-full {{ $i % 2 == 0 ? 'rounded-tr-xl rounded-br-xl' : 'rounded-tl-xl rounded-bl-xl' }}"></iframe>
					</div>
				</div>
				@endif
