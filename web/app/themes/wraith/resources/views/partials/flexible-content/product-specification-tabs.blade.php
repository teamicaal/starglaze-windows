        ...
        @if (have_rows('tab'))
            ...
            <div class="container relative configurator-bar mx-auto scroll-container overflow-x-hidden snap-x flex gap-[10px] rounded-full blue-bg-gradient p-[10px] z-10">
                @while (have_rows('tab'))
                    ...
                    @endphp
                    <button
                        class="uppercase grow whitespace-nowrap font-bold font-serif rounded-full snap-center py-2 px-16 text-lg lg:px-20 lg:text-lg {{ $i == 1 ? 'active' : null }}"
                                    ...
                                    <div
                                        ...
                                        @while (have_rows('swatches_content'))
                                            ...
                                            <div data-image-swatch="{{ $swatch_name_clean }}" class="flex flex-col items-center justify-center cursor-pointer">
                                                <div class="w-[120px] h-[100px] hardware-height mb-2 rounded-[5px] bg-white group shadow-md overflow-hidden relative">
                                ...
                                @while (have_rows('swatches_content'))
                                    ...
                                    <div data-image-featured="{{ $swatch_name_clean }}"
                                        ...
                                        <div class="featured_front">
                                            ...
                                            <p class="text-xs absolute left-1/2 -translate-x-1/2 mt-3">*Colour configurations are for illustration purposes only. For detailed colours, contact us today to receive swatches from one of our approved dealers.</p>
                                            <img class="w-full h-[300px] lg:h-[500px] object-contain"
