                                ...
                                @while (have_rows('swatches_content'))
                                    ...
                                    <div data-image-featured="{{ $swatch_name_clean }}"
                                        ...
                                        <div class="featured_front">
                                            ...
                                            <p class="text-xs mb-0">*Colour configurations are for illustration purposes only. For detailed colours, contact us today to receive swatches from one of our approved dealers.</p>
                                            <img class="w-full h-[300px] lg:h-[500px] object-contain"
